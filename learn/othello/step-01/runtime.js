...
(function () {
  ...
  var HINTS         = ["画面座標はピクセル単位。col 列目の左端は col * CELL、row 行目の上端は row * CELL。", "マス本体は screen.fillRect(x, y, CELL, CELL, Color.BOARD)。引数は左上 x, 左上 y, 幅, 高さ, 色。", "枠線は screen.strokeRect を同じ引数で。塗りの上から細い線が乗り、格子っぽく見える。"];
  var TESTS         = [{"name": "左上のマスが緑で塗られている", "type": "cell-color", "col": 0, "row": 0, "color": [30, 120, 72], "tolerance": 20}, {"name": "右下のマスも緑で塗られている", "type": "cell-color", "col": 7, "row": 7, "color": [30, 120, 72], "tolerance": 20}, {"name": "中央付近も緑で塗られている", "type": "cell-color", "col": 3, "row": 4, "color": [30, 120, 72], "tolerance": 20}];
  var STEP_ID       = "step-01";

...
(function () {
  ...
  var HINTS         = ["setup() では代入文を 4 つ並べるだけ。例: board[3][3] = WHITE;", "render の石描画は、まず stone を取り出す: int stone = board[row][col]; 次に if (stone != EMPTY) の中で描く。", "石の色は三項演算子で一発: Color c = (stone == BLACK) ? Color.BLACK : Color.WHITE; 半径は CELL/2 - 4 で盤面より少し小さく。"];
  var TESTS         = [{"name": "(col 3, row 3) に白石が置かれている", "type": "cell-color", "col": 3, "row": 3, "color": [255, 255, 255], "tolerance": 20}, {"name": "(col 4, row 4) に白石が置かれている", "type": "cell-color", "col": 4, "row": 4, "color": [255, 255, 255], "tolerance": 20}, {"name": "(col 4, row 3) に黒石が置かれている", "type": "cell-color", "col": 4, "row": 3, "color": [0, 0, 0], "tolerance": 20}, {"name": "(col 3, row 4) に黒石が置かれている", "type": "cell-color", "col": 3, "row": 4, "color": [0, 0, 0], "tolerance": 20}, {"name": "空マスはまだ緑のまま", "type": "cell-color", "col": 0, "row": 0, "color": [30, 120, 72], "tolerance": 20}];
  var STEP_ID       = "step-02";

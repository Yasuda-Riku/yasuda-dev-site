...
(function () {
  ...
  function b64ToBinaryString(b64) {
    // atob yields a string where each char is one byte (Latin-1).
    // cheerpOSAddStringFile preserves byte values.
    return atob(b64);
  }
  ...
  async function ensureCheerpJ() {
    ...
    await cheerpOSAddStringFile("/str/sdk.jar",    b64ToBinaryString(SDK_JAR_B64));
    await cheerpOSAddStringFile("/str/step01.jar", b64ToBinaryString(STEP01_JAR_B64));

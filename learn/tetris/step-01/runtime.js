...
(function () {
  ...
  var HINTS         = ["x は col を CELL 倍、y は row を CELL 倍。x = col * CELL; / y = row * CELL; のように書きます。", "fillRect の最初の 2 つは左上の座標。ここを (x + 1, y + 1) にすると、マス同士が 1px ずつ離れて見えます。", "fillRect の 3 番目・4 番目は幅と高さ。どちらも (CELL - 2) にすれば、左右上下 1px ずつ引いた大きさで描けます。"];
  var TESTS         = [{"name": "左上のセルが暗いグレーで塗られている", "type": "cell-color", "col": 0, "row": 0, "color": [38, 34, 30]}, {"name": "中央のセルも暗いグレー", "type": "cell-color", "col": 5, "row": 10, "color": [38, 34, 30]}, {"name": "右下のセルも暗いグレー", "type": "cell-color", "col": 9, "row": 19, "color": [38, 34, 30]}];
  var STEP_ID       = "step-01";

...
(function () {
  ...
  window.addEventListener("keydown", async function (e) {
    ...
    // Always swallow arrows / space while the game is running, so the
    // page does not scroll under the player.
    if ([32, 37, 38, 39, 40].indexOf(e.keyCode) !== -1) {
      e.preventDefault();
    }
    try { await gameInstance.handleKey(e.keyCode | 0); } catch (_) {}
  });
